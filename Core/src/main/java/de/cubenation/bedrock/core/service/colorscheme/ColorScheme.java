...
public class ColorScheme {
    ...
    public static ColorScheme getColorScheme(FoundationPlugin plugin, String name) {
    ...
    public static ColorScheme getColorScheme(FoundationPlugin plugin, ColorSchemeName name) {
        ...
        try {
            ...
            Constructor<?> constructor = cls.getConstructor(FoundationPlugin.class);
